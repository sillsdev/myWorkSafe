...
namespace Dolinay
{
    ...
    class DriveDetector : IDisposable 
    {
    	...
    	public event DriveDetectorEventHandler DeviceSomethingHappened;//hatton added
            ...
            if (m.Msg == WM_DEVICECHANGE)
            {
				...
				switch (m.WParam.ToInt32())
				{
					...
					case DBT_DEVICEREMOVECOMPLETE:
						...
						//hatton added
						// we can't tell much at this point, but other state-logic may be able to use
						// this indicator to figure out what did.  I'm using it to detect possible
						// *physical removal of the usb key* after we've "ejected" it (unmounted, more acurately)
					case DBT_DEVNODES_CHANGED:
						if (DeviceSomethingHappened != null)
						{
							DriveDetectorEventArgs e = new DriveDetectorEventArgs();
							e.Drive = string.Empty;//we don't know
							DeviceSomethingHappened(this, e);
						}
